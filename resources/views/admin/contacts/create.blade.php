                    ...
                    <form action="{{ route('admin.contacts.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="type" id="type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="qr_code" {{ old('type') == 'qr_code' ? 'selected' : '' }}>QR Code</option> {{-- <-- 1. DITAMBAHKAN --}}
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="value" name="value" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('value') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="icon_svg" name="icon_svg" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('icon_svg') }}</textarea>
                        ...
                        <div class="mb-4">
                            <label for="is_active" class="inline-flex items-center">
                                <input id="is_active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_active" value="1" @checked(old('is_active', true))>
