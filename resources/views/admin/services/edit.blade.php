...
<x-app-layout>
    ...
    {{-- Script untuk CKEditor (Tetap Sama) --}}
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Inisialisasi editor yang terlihat saat load
                ...
                // (Ini adalah PENTING agar CKEditor tidak rusak saat tab di-klik)
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.services.update', $service->slug) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div x-show="tab === '{{ $locale }}'" class="space-y-6" style="display: none;">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="content_{{ $locale }}" name="content[{{ $locale }}]" rows="5" 
                                                  ...
                                                  data-locale="{{ $locale }}">{{ old('content.' . $locale, $service->getTranslation('content', $locale)) }}</textarea>
