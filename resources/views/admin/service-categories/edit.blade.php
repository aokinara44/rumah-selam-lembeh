        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    {{-- Ganti $serviceCategory->id menjadi $serviceCategory->slug --}}
                    {{-- ========================================================== --}}
                    <form method="POST" action="{{ route('admin.service-categories.update', $serviceCategory->slug) }}">
                        @csrf
                        @method('PUT')
                        ...
                        @foreach(config('app.available_locales') as $locale => $localeName)
                            <div class="mb-4">
                                ...
                                <x-text-input 
                                    ...
                                    :name="'name[' . $locale . ']'" 
                                    {{-- Ambil nilai lama (jika ada error) ATAU nilai terjemahan yang ada --}}
                                    :value="old('name.' . $locale, $serviceCategory->getTranslation('name', $locale))" 
